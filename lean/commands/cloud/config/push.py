...
def push(name: str, project_id: str, description: str, dry_run: bool) -> None:
    ...
    cli_credentials = {
        ...
        "polygon-s3-endpoint": cli_config_manager.polygon_s3_endpoint.get_value(),
        "polygon-s3-access-key": cli_config_manager.polygon_s3_access_key.get_value(),
        "polygon-s3-secret-key": cli_config_manager.polygon_s3_secret_key.get_value(),
        "polygon-s3-bucket": cli_config_manager.polygon_s3_bucket.get_value(),
    ...
    sensitive_keys = [
        ...
        "polygon-api-key", "polygon-s3-access-key", "polygon-s3-secret-key",
