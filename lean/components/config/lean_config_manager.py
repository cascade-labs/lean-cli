...
class LeanConfigManager:
    ...
    def get_complete_lean_config(self,
        ...
        config_defaults = {
            ...
            "s3-access-key": self._cli_config_manager.s3_access_key.get_value(default=""),
            "s3-secret-key": self._cli_config_manager.s3_secret_key.get_value(default=""),
            "s3-endpoint": self._cli_config_manager.s3_endpoint.get_value(default=""),
            "tradealert-s3-bucket": self._cli_config_manager.tradealert_s3_bucket.get_value(default=""),
            "s3-region": self._cli_config_manager.s3_region.get_value(default=""),
            "polygon-api-key": self._cli_config_manager.polygon_api_key.get_value(default=""),
            "polygon-s3-endpoint": self._cli_config_manager.polygon_s3_endpoint.get_value(default=""),
            "polygon-s3-access-key": self._cli_config_manager.polygon_s3_access_key.get_value(default=""),
            "polygon-s3-secret-key": self._cli_config_manager.polygon_s3_secret_key.get_value(default=""),
            "polygon-s3-bucket": self._cli_config_manager.polygon_s3_bucket.get_value(default=""),
            ...
            "hyperliquid-s3-bucket": self._cli_config_manager.hyperliquid_s3_bucket.get_value(default=""),
